 ...
 * C source code generated on : Wed Sep 18 18:53:24 2024
 *
...
typedef struct {
  ...
  void *Potentiometer_PWORK;           /* '<Root>/ Potentiometer' */
  void *StrainGauge_PWORK;             /* '<Root>/Strain Gauge ' */
  struct {
    void *LoggedData;
  } Tensaopot_PWORK;                   /* '<Root>/Tensao-pot ' */
  ...
  struct {
    void *LoggedData;
  } Tensaostrain_PWORK;                /* '<Root>/Tensao-strain ' */
} DW_test_T;
...
struct P_test_T_ {
  ...
  real_T Potentiometer_MaxMissedTicks; /* Mask Parameter: Potentiometer_MaxMissedTicks
                                        ...
                                        */
  real_T StrainGauge_MaxMissedTicks;   /* Mask Parameter: StrainGauge_MaxMissedTicks
                                        * Referenced by: '<Root>/Strain Gauge '
                                        */
  ...
  real_T Potentiometer_YieldWhenWaiting;/* Mask Parameter: Potentiometer_YieldWhenWaiting
                                         * Referenced by: '<Root>/ Potentiometer'
                                         */
  real_T StrainGauge_YieldWhenWaiting; /* Mask Parameter: StrainGauge_YieldWhenWaiting
                                        * Referenced by: '<Root>/Strain Gauge '
                                        */
  ...
  int32_T Potentiometer_Channels;      /* Mask Parameter: Potentiometer_Channels
                                        * Referenced by: '<Root>/ Potentiometer'
                                        */
  int32_T StrainGauge_Channels;        /* Mask Parameter: StrainGauge_Channels
                                        * Referenced by: '<Root>/Strain Gauge '
                                        */
  ...
  int32_T Potentiometer_RangeMode;     /* Mask Parameter: Potentiometer_RangeMode
                                        * Referenced by: '<Root>/ Potentiometer'
                                        */
  int32_T StrainGauge_RangeMode;       /* Mask Parameter: StrainGauge_RangeMode
                                        * Referenced by: '<Root>/Strain Gauge '
                                        */
  ...
  int32_T Potentiometer_VoltRange;     /* Mask Parameter: Potentiometer_VoltRange
                                        * Referenced by: '<Root>/ Potentiometer'
                                        */
  int32_T StrainGauge_VoltRange;       /* Mask Parameter: StrainGauge_VoltRange
                                        * Referenced by: '<Root>/Strain Gauge '
                                        */
};
