...
typedef struct {
  real_T StrainGauge1;                 /* '<Root>/Strain Gauge 1' */
} B_test_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  void *StrainGauge1_PWORK;            /* '<Root>/Strain Gauge 1' */
  struct {
    void *LoggedData;
  } strain_gauge_angle_PWORK;          /* '<Root>/strain_gauge_angle' */
} DW_test_T;
...
struct P_test_T_ {
  real_T StrainGauge1_MaxMissedTicks;  /* Mask Parameter: StrainGauge1_MaxMissedTicks
                                        * Referenced by: '<Root>/Strain Gauge 1'
                                        */
  real_T StrainGauge1_YieldWhenWaiting;/* Mask Parameter: StrainGauge1_YieldWhenWaiting
                                        * Referenced by: '<Root>/Strain Gauge 1'
                                        */
  int32_T StrainGauge1_Channels;       /* Mask Parameter: StrainGauge1_Channels
                                        * Referenced by: '<Root>/Strain Gauge 1'
                                        */
  int32_T StrainGauge1_RangeMode;      /* Mask Parameter: StrainGauge1_RangeMode
                                        * Referenced by: '<Root>/Strain Gauge 1'
                                        */
  int32_T StrainGauge1_VoltRange;      /* Mask Parameter: StrainGauge1_VoltRange
                                        * Referenced by: '<Root>/Strain Gauge 1'
                                        */
};
