...
typedef struct {
  ...
  real_T ref;                          /* '<Root>/Manual Switch' */
  real_T yk;                           /* '<S2>/Sum1' */
  real_T K;                            /* '<Root>/K' */
  real_T Sum3;                         /* '<Root>/Sum3' */
  real_T Gain3[4];                     /* '<S1>/Gain3' */
  real_T Sum[4];                       /* '<S1>/Sum' */
...
typedef struct {
  ...
  void *Potentiometer_PWORK;           /* '<S2>/Potentiometer' */
  void *StrainGage_PWORK;              /* '<S2>/Strain Gage' */
...
struct P_test_T_ {
  ...
  real_T AnalogOutput_InitialValue;    /* Mask Parameter: AnalogOutput_InitialValue
                                        * Referenced by: '<Root>/Analog Output'
                                        */
  real_T Potentiometer_MaxMissedTicks; /* Mask Parameter: Potentiometer_MaxMissedTicks
                                        * Referenced by: '<S2>/Potentiometer'
                                        */
  real_T StrainGage_MaxMissedTicks;    /* Mask Parameter: StrainGage_MaxMissedTicks
                                        * Referenced by: '<S2>/Strain Gage'
                                        */
  real_T AnalogOutput_MaxMissedTicks;  /* Mask Parameter: AnalogOutput_MaxMissedTicks
                                        * Referenced by: '<Root>/Analog Output'
                                        */
  real_T Potentiometer_YieldWhenWaiting;/* Mask Parameter: Potentiometer_YieldWhenWaiting
                                         * Referenced by: '<S2>/Potentiometer'
                                         */
  real_T StrainGage_YieldWhenWaiting;  /* Mask Parameter: StrainGage_YieldWhenWaiting
                                        * Referenced by: '<S2>/Strain Gage'
                                        */
  real_T AnalogOutput_YieldWhenWaiting;/* Mask Parameter: AnalogOutput_YieldWhenWaiting
                                        * Referenced by: '<Root>/Analog Output'
                                        */
  int32_T Potentiometer_Channels;      /* Mask Parameter: Potentiometer_Channels
                                        * Referenced by: '<S2>/Potentiometer'
                                        */
  int32_T StrainGage_Channels;         /* Mask Parameter: StrainGage_Channels
                                        * Referenced by: '<S2>/Strain Gage'
                                        */
  int32_T AnalogOutput_Channels;       /* Mask Parameter: AnalogOutput_Channels
                                        * Referenced by: '<Root>/Analog Output'
                                        */
  int32_T Potentiometer_RangeMode;     /* Mask Parameter: Potentiometer_RangeMode
                                        * Referenced by: '<S2>/Potentiometer'
                                        */
  int32_T StrainGage_RangeMode;        /* Mask Parameter: StrainGage_RangeMode
                                        * Referenced by: '<S2>/Strain Gage'
                                        */
  int32_T AnalogOutput_RangeMode;      /* Mask Parameter: AnalogOutput_RangeMode
                                        * Referenced by: '<Root>/Analog Output'
                                        */
  int32_T Potentiometer_VoltRange;     /* Mask Parameter: Potentiometer_VoltRange
                                        * Referenced by: '<S2>/Potentiometer'
                                        */
  int32_T StrainGage_VoltRange;        /* Mask Parameter: StrainGage_VoltRange
                                        * Referenced by: '<S2>/Strain Gage'
                                        */
  ...
  real_T DiscreteTimeIntegrator1_IC;   /* Expression: 0
                                        * Referenced by: '<Root>/Discrete-Time Integrator1'
                                        */
  real_T Reference_Amplitude;          /* Expression: 30
                                        * Referenced by: '<Root>/Reference'
                                        */
  real_T Reference_Frequency;          /* Expression: 0.2
                                        * Referenced by: '<Root>/Reference'
                                        */
